            ...
            <div class="card bk-shadow">
                <div class="card-body py-3">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-5">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email"
                                    class="h-75 form-control @error('email') is-invalid @enderror" name="email"
                        ...
                        <div class="row mb-2">
                            <label for="password"
                                class="col-md-4 col-form-label text-md-end text-muted">{{ __('Password') }}</label>

                            <div class="col-md-6">
                                <input id="password" type="password"
                                    class="h-75 form-control @error('password') is-invalid @enderror" name="password"
                ...
                <div class="card-footer bg-white">
                    <a href="{{ route('google.redirect') }}" class="btn d-inline-block border w-100 fw-bold">
